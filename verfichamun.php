...
<div id="tabs" style="font-size:10px">
  ...
  <div id="tabs-1" class='panel'>
	<?php
	$query = "SELECT cvegeo as \"Clave  Municipio\", nombre as \"Nombre\",pob1 as\"Población total\",pob2 as\"Población de 0 a 2 años\",pob3 as\"Población de 0 a 4 años\",pob4 as\"Población de 3 a 5 años\",pob5 as\"Población de 6 a 11 años\",pob6 as\"Población de 8 a 14 años\",pob7 as\"Población de 12 a 14 años\",pob8 as\"Población de 0 a 14 años\",
	...
	pob81 as\"Población masculina de 70 años y más\" FROM datosestadisticos.municipal_poblacion where cvegeo = '$geografico'";
	//echo $query;
  ...
  <div id="tabs-2" class='panel'>
	<?php
	$query = "SELECT cvegeo as\"Clave Municipio\", grado_marg as\"Grado de Marginación CONAPO\", gra_re_soc \"Grado de Rezago Social CONEVAL\" FROM datosestadisticos.municipal_desarrollo_social where cvegeo = '$geografico'";
	//echo $query;
	$result = pg_query($query) or die('Query failed: ' . pg_last_error());
	$i = pg_num_fields($result);
	if ($row = pg_fetch_array($result)){
  ...
  <div id="tabs-3" class='panel'>
	<?php
	$query = "SELECT cvegeo as\"Clave Municipio\",indi1 as\"Pob. >= 3 que habla alguna lengua indígena (LI)\",indi2 as\"Pob. femenina >= 3 que habla alguna LI\",indi3 as\"Pob. masculina >= 3 que habla alguna LI\",indi4 as\"Pob. >= 3 que habla alguna LI y no habla Esp.\",indi5 as\"Pob. femenina >= 3 que habla alguna LI y no habla Esp.\",
...
indi16 as\"Pob. >= 5 que habla alguna LI y habla Esp.\",indi17 as\"Pob. femenina >= 5 que habla alguna LI y habla Esp.\",indi18 as\"Pob. masculina >= 5 que habla alguna LI y habla Esp.\",indi19 as\"Hogares censales indígenas\",
indi20 as\"Población en hogares censales indígenas\" FROM datosestadisticos.municipal_lengua_indigena where cvegeo = '$geografico'";
	//echo $query;
	$result = pg_query($query) or die('Query failed: ' . pg_last_error());
	$i = pg_num_fields($result);
	if ($row = pg_fetch_array($result)){
