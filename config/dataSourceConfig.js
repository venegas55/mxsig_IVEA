define(function(){
	var sources = {
        ...
        layersSeaIde:{
			url:'http://127.0.0.1/mdmservices/fieldtypes',
			contentType : "application/json; charset=utf-8",
            type: 'POST',
            dataType: "json"
        },
        exportList:{
			url:'http://127.0.0.1/mdmservices/export',
			type: 'POST',
			contentType : "application/json; charset=utf-8",
			dataType: "json",
		},
		saveStats:{
			url:'http://127.0.0.1/mdmservices/stats/layers',
			type: 'POST',
			contentType : "application/json; charset=utf-8",
			dataType: "json",
		},
		share:{
			contentType : "application/json; charset=utf-8",
			url:'http://127.0.0.1/mdmservices/share',
			type: 'POST',
			dataType: "json"
        },
		shareEmail:{
			contentType : "application/json; charset=utf-8",
			url:'http://127.0.0.1/mdmservices/share/email',
			type: 'POST',
			dataType: "json"
        },
        identify:{
			url:'http://127.0.0.1/mdmservices/identify',
			type: 'POST',
			contentType : "application/json; charset=utf-8",
			dataType: "json",
        },
        bufferLayer:{
            url:'http://127.0.0.1/mdmservices/totals',
            contentType : "application/json; charset=utf-8",
            type: 'POST',
            dataType: "json"
        },
        identifyDetail:{
			url:'http://127.0.0.1/mdmservices/query',
            type:'POST',
            contentType : "application/json; charset=utf-8",
            dataType: "json"
        },
        ...
        kml:{
			save:'http://127.0.0.1/mdmexport/kml/download',
			read:'http://127.0.0.1/mdmexport/kml/upload'
		},
		gpx:{
			save:'http://127.0.0.1/mdmexport/gpx/download',
			read:'http://127.0.0.1/mdmexport/gpx/upload'
		},
		geometry:{
			store:{
				url:'http://127.0.0.1/mdmservices/geometry',
				type: 'POST',
				dataType: "json",
				contentType : "application/json; charset=utf-8"
			},
			addBuffer:{
				url:'http://127.0.0.1/mdmservices/buffer',
				type:'POST',
				dataType:'json',
				contentType:'application/json; charset=utf-8'
			},
			restore:{
				url:'http://127.0.0.1/mdmservices/wkt/geometries',
				type: 'GET',
				dataType: "json",
				contentType : "application/json; charset=utf-8"
			},
		...
		timeLine:'json/linetime.do',
       		...
       		leyendUrl:'http://127.0.0.1/cgi-bin/mapserv?map=/opt/map/mdm60/mdm6leyenda_mexico.map&Request=GetLegendGraphic&format=image/png&Version=1.1.1&Service=WMS&LAYER=',
       		synonyms:{
       			list:{
		...
		mousePosition:{
			elevation:{
				url:'http://127.0.0.1/mdmservices/raster/elevation',
				type:'POST',
				dataType:'json'
	    	}
		},
		files:{
	    	download:'http://127.0.0.1/mdmdownloadfile/download'
		}
	};
	return sources;
});
